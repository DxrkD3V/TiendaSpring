...
public class ObjectsInit implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Product product9 = new Product(null, "Rolls Royce Phantom","https://cdn.motor1.com/images/mgl/JOBqOJ/s1/phantom-scintilla-private-collection---0.jpg", "Lujo sin igual con detalles artesanales.", 450000.00, "Rolls Royce", lujo);
